...
pub unsafe fn PyRun_String(
    ...
    PyRun_StringFlags(string, s, g, l, std::ptr::null_mut())
}

// skipped macro PyRun_AnyFile
#[inline]
pub unsafe fn PyRun_AnyFile(fp: *mut FILE, name: *const c_char) -> c_int {
    PyRun_AnyFileExFlags(fp, name, 0, std::ptr::null_mut())
}

// skipped macro PyRun_AnyFileEx
#[inline]
pub unsafe fn PyRun_AnyFileEx(fp: *mut FILE, name: *const c_char, closeit: c_int) -> c_int {
    PyRun_AnyFileExFlags(fp, name, closeit, std::ptr::null_mut())
}
